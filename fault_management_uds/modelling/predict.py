...
def get_full_output(model, dataset, scalers, configs):


    complete_output_dict = {return_name: np.zeros((n_obs, return_dim)) 
                            for return_name, return_dim 
                            in model.model.returns.items() if return_name != 'prediction'}
