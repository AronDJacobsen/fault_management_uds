...
# default train
#python fault_management_uds/train.py --config "transformer/_tests/with_embedding.yaml" --num_workers 0

#python fault_management_uds/train.py --config "transformer/6_final_selection/16_best.yaml" --num_workers 0
#python fault_management_uds/train.py --config "linear_regression/1e-4.yaml" --num_workers 0
#python fault_management_uds/train.py --config "lstm/0.0005_32_2.yaml" --num_workers 0
...
# Evaluation:
#python fault_management_uds/evaluate_detection.py --model_save_path "transformer/7_anomalous/iteration=0_250106_0752" --data_group "anomalous" --num_workers 0
